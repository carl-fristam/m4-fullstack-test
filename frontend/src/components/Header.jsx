...
export default function Header({ username, handleLogout }) {
    return (
        <nav className="fixed top-0 w-full z-50 bg-slate-50/90 backdrop-blur-sm flex justify-center text-slate-800 h-24">
            <div className="w-full max-w-7xl px-6 grid grid-cols-3 items-center">
                ...
                <div className="flex items-center justify-end gap-10">
                    ...
                    <button
                        ...
                        className="text-sm font-bold text-slate-400 hover:text-[#E40000] transition-colors uppercase tracking-wider"
                    >
                        Log Out
                    </button>
                </div>
